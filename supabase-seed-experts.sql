-- =====================================================================
-- 7개 분야 + 분야별 10명 테스트 시드 (총 70명)
-- 분야: 변호사·의사·노무사·변리사·세무사·손해사정사·감정평가사 (회계사 제외)
...
from (values
  ...
  (5, 'tax',       '세무사',     array['세무조사','상속·증여','부가세']),
  (6, 'adjuster',  '손해사정사', array['교통사고','산재','보험금분쟁']),
  (7, 'appraiser', '감정평가사', array['부동산평가','토지보상','경매감정'])
