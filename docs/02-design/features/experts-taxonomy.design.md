...
| LAW-08 | IT·금융·지식재산 | IT·개인정보 · 저작권**분쟁·소송** · 콘텐츠·엔터분쟁 *(특허·상표는 변리사로 이관, 저작권 '등록·상담'은 변리사 PAT-06로 분리)* |
| LAW-09 | 기타 | 개인회생 · 개인파산 · 법인회생 · 법인파산 · 소비자분쟁 · 계약서검토 · 군형법 · 헌법 |

**제거/이관 내역(원본 대비)**: ~~노동~~→노무사(LAB), ~~세금(조세·상속세·증여세)~~→세무사(TAX), ~~특허·상표~~→변리사(PAT), 저작권 **등록·상담**→변리사(PAT-06, 분쟁·소송은 LAW-08 잔류). 행정·의료소송은 변호사 고유로 유지.
...
### 4.4 노무사 (LAB) ✅ — 제공본 (노동사건 승격, 2026-06-10 확정)

> B2C(개인 근로자)와 B2B(기업 대상)가 섞인 직업. 소비자 SOS 매칭은 주로 LAB-01·02(개인)에 집중되고, LAB-03~07(B2B)은 전문가 프로필 표시·향후 B2B용.

| 코드 | 중분류 | 세부 | 성격 |
|---|---|---|---|
| LAB-01 | 노동사건 | 부당해고 · 임금체불 · 퇴직금 · 징계 · 직장내괴롭힘 · 노동위원회사건 | B2C |
| LAB-02 | 산재 | — | B2C |
| LAB-03 | 기업 노무 자문 | 기업자문 · 급여/4대보험 아웃소싱 | B2B |
| LAB-04 | HR 컨설팅 | 임금체계구축 · 평가제도 · 채용제도 · 근로시간체계 · 직무분석·평가 | B2B |
| LAB-05 | 산업안전 | 안전보건체계구축 · 위험성평가 · 산업안전 노동청대응 | B2B |
| LAB-06 | 노사관계 | 단체교섭 · 파업대응 · 노사관계전략 · 노조대응자문 | B2B |
| LAB-07 | 건설노무 | 건설 일용근로자 관리 · 건설 노무 신고 대행 | B2B |
...
| PAT-04 | 실용신안 |
| PAT-05 | 해외출원·PCT |
| PAT-06 | 저작권 (등록·상담) — *분쟁·소송은 변호사 LAW-08* |
